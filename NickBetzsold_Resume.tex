...
\begin{tabular}{rp{11cm}}
  ...
  % & Certification---Stanford University (2017)\\ \\
...
\begin{tabular}{r|p{11cm}}
  ...
  & \footnotesize{Develop a venue risk-analysis tool and manage the integration of vast streaming data with statistical models and constrained security resources to optimally minimize risk.} \\
  ...
  & \footnotesize{Model airborne chemical and biological threat detection sensors via data simulations in R and recommend optimal responses that minimize cost.} \\ \multicolumn{2}{c}{} \\
